...
from my_panda_gym.envs.tasks.pushfrontrange import PushFrontRange
...
class PandaPushFrontRangeEnv(RobotTaskEnv):
    ...
    def __init__(self, render: bool = False, reward_type: str = "sparse", control_type: str = "ee") -> None:
        ...
        task = PushFrontRange(sim, reward_type=reward_type)
