...
from my_panda_gym.envs.tasks.pushfrontstill import PushFrontStill
...
class PandaPushFrontStillEnv(RobotTaskEnv):
    ...
    def __init__(self, render: bool = False, reward_type: str = "sparse", control_type: str = "ee") -> None:
        ...
        task = PushFrontStill(sim, reward_type=reward_type)
