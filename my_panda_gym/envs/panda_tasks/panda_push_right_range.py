...
from my_panda_gym.envs.tasks.pushrightrange import PushRightRange
...
class PandaPushRightRangeEnv(RobotTaskEnv):
    ...
    def __init__(self, render: bool = False, reward_type: str = "sparse", control_type: str = "ee") -> None:
        ...
        task = PushRightRange(sim, reward_type=reward_type)
