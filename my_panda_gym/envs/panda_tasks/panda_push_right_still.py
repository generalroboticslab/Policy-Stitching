...
from my_panda_gym.envs.tasks.pushrightstill import PushRightStill
...
class PandaPushRightStillEnv(RobotTaskEnv):
    ...
    def __init__(self, render: bool = False, reward_type: str = "sparse", control_type: str = "ee") -> None:
        ...
        task = PushRightStill(sim, reward_type=reward_type)
