...
class PickAndPlace4(Task):
    ...
    def _create_scene(self) -> None:
        ...
        self.sim.create_box(
            body_name="object",
            half_extents=np.array([self.bar_length / 2, self.object_size / 2, self.object_size / 2]),
            mass=1.0,
    ...
    def reset(self) -> None:
        ...
        self.sim.set_base_pose("object", object_position, np.array([0.0, 0.0, np.random.uniform(-1.57, 1.57)]))
