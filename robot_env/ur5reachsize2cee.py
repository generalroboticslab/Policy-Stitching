...
class Ur5ReachSize2Cee:
    ...
    def __init__(self, robot, models: Models, camera=None, vis=False) -> None:
        ...
        self.action_shape = 3  # control end effector movement
    ...
    def step(self, action, control_method):
        """
        ...
        if control_method == 'joint':
            ...
            # 3d action for end effector control
            action = np.concatenate([action * 0.05, np.zeros(4)])
